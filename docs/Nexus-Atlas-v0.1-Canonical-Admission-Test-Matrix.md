...
| CA-A01 | admission/reconciliation | Only one Commit Candidate authorized | one insert and seven deferred | 1 insert, 0 noop, 0 conflict, 7 deferred | 1 | — | explicit-authorization; idempotent-admission | Unselected remains deferred |
...
| CA-A04 | admission/reconciliation | Accepted eight-Candidate Import Plan with repository, default branch, commit, issue, pull request, release and tag Candidates; only the repository Candidate is authorized and its exact canonical Evidence already exists in Graph | one noop and seven deferred | 0 insert, 1 noop, 0 conflict, 7 deferred | 1 | — | idempotent-admission; deterministic-canonical-identity | The validated GitHub core Candidates remain in the Plan; only the authorized repository observation participates and is idempotent |
...
| CA-A08 | admission/reconciliation | Accepted three-Candidate Import Plan with repository, default branch and commit Candidates; only the commit Candidate is authorized, while Graph contains the same Commit Source Record as canonical Evidence at an older capturedAt | new insert and old Evidence retained | 1 insert, 0 noop, 0 conflict, 2 deferred | 1 | — | history-preserved; deterministic-canonical-identity | A legal Plan retains repository and branch core Candidates; the same source record at a new capture produces a new canonical ID and preserves the old Evidence |
...
| CA-G02 | governance/safety | Source-local confirmation and fixed governance defaults | verification confirmed; freshness unknown; personal/project_only/no confirmation | 8 insert, 0 noop, 0 conflict, 0 deferred | 8 | — | source-authority-preserved; freshness-not-promoted; no-semantic-promotion | Confirmed is not current; defaults remain conservative |
...
| CA-G04 | governance/safety | Admission Plan was built with one Candidate authorized, but Apply receives an empty authorizedCandidateIds selection | reject with zero mutation | — | — | CANONICAL_ADMISSION_AUTHORIZATION_MISMATCH | explicit-authorization; atomic-apply; input-unchanged | Admission Plan cannot self-prove canonical authorization; Apply rebinds the explicit selection |
| CA-G05 | governance/safety | Accepted three-Candidate Import Plan with repository, default branch and issue Candidates; only the Issue Candidate is authorized | Evidence proposal only; repository and branch remain deferred | 1 insert, 0 noop, 0 conflict, 2 deferred | 1 | — | evidence-only; no-semantic-promotion | A legal Plan includes the GitHub core Candidates; Issue state is not an action instruction and unselected repository/branch Candidates remain deferred |
| CA-G06 | governance/safety | Accepted four-Candidate Import Plan with repository, default branch, merged pull request and published release Candidates; only the pull request and release Candidates are authorized | Evidence proposals; repository and branch deferred; Project unchanged | 2 insert, 0 noop, 0 conflict, 2 deferred | 2 | — | no-semantic-promotion; no-derived-projection-mutation | A legal Plan includes the GitHub core Candidates; source observations do not update Project phase, complete a Milestone, or mutate currentVersion |
| CA-G07 | governance/safety | Complete authorized admission | Evidence proposals with unchanged edges/package | 8 insert, 0 noop, 0 conflict, 0 deferred | 8 | — | no-derived-projection-mutation; no-semantic-promotion | No Edge or derived mutation |
...
| CA-C02 | determinism/application | Mutable ordinary inputs | unchanged inputs; deeply frozen future output | 8 insert, 0 noop, 0 conflict, 0 deferred | 8 | — | input-unchanged; deeply-frozen | Pure boundary |
| CA-C03 | determinism/application | Complete authorization in source order | decisions and proposals follow Candidate order | 8 insert, 0 noop, 0 conflict, 0 deferred | 8 | — | deterministic-canonical-identity | Preserve source lineage |
| CA-C04 | determinism/application | Conflict-free accepted Admission Plan | new valid Graph with appended Evidence only | 8 insert, 0 noop, 0 conflict, 0 deferred | 8 | — | atomic-apply; graph-valid-after-apply; input-unchanged; no-derived-projection-mutation | Pure valid Graph application |
